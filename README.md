...
- **v4:** Bridge-Ausbau (Push, HealthKit), Apple Foundation Models für kleine Edits, mehrere Chat-Threads, Abo-OAuth sobald OpenAI/Anthropic es öffnen, Freemium via StoreKit 2 (Gate: Anzahl gespeicherter Mini-Apps), Teilen/Galerie (erst hier wird ein Server nötig).
